...
if ( ! class_exists( 'LP_Question_Satisfaction' ) ) {

	/**
	 * Class LP_Question_Satisfaction
	 */
	class LP_Question_Satisfaction extends LP_Question {

		/**
		 * @var string
		 */
		protected $_question_type = 'satisfaction';
		...
		/**
		 * LP_Question_Satisfaction constructor.
		 *
		...
		public function render( $args = false ) {
			learn_press_satisfaction_get_template( 'answer.php', array( 'question' => $this ) );
		}
